...
AMultiplayerAdventureCharacter::AMultiplayerAdventureCharacter()
{
...
void AMultiplayerAdventureCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AMultiplayerAdventureCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMultiplayerAdventureCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AMultiplayerAdventureCharacter::Look);
	}
	else
	{
...
void AMultiplayerAdventureCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMultiplayerAdventureCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
